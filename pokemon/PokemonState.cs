...
{
    public Poisoned(int maxTurns, int appliedTurns, int probability) : base(maxTurns, appliedTurns, probability)
    {
        _maxTurns = 3;
        _appliedTurns = 0;
        _probability -= 10;
...
{
    public AttacUp(int maxTurns, int appliedTurns, int probability) : base(maxTurns, appliedTurns, probability)
    {
        _maxTurns = 3;
        _appliedTurns = 0;
        _probability -= 100;
